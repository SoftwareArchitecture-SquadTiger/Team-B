...
const kafka = new Kafka({
    ...
    brokers: ['192.168.1.9:9093'], // Ensure this matches the broker's advertised.listeners
  });
...
const produceTestMessages = async () => {
  ...
  const messages = [
    ...
    // {
      ...
      // data: { donorId: '8042f3db-20ad-4b8a-84fa-89987c72b9b8'},
    // },
    // {
